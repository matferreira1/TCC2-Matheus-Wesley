...
async def open_db() -> None:
    ...
    await _db.execute("PRAGMA cache_size=-65536;")    # 64 MB — reduz leituras de disco no FTS5
    await _db.execute("PRAGMA mmap_size=268435456;")  # 256 MB de mmap — acesso direto à memória
