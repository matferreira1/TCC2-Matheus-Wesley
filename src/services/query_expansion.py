...
_SYNONYMS: dict[str, frozenset[str]] = {
    ...
    "previdencia": frozenset({"inss", "rgps", "beneficio", "segurado"}),
    "previdencia social": frozenset({"inss", "rgps", "beneficio", "contribuicao", "aposentadoria"}),
    "inss": frozenset({"previdencia", "rgps", "beneficio", "segurado"}),
    "rgps": frozenset({"previdencia", "inss", "beneficio"}),
    "aposentadoria": frozenset({"beneficio", "inss", "previdencia", "proventos"}),
    "aposentadoria invalidez": frozenset({"incapacidade", "permanente", "beneficio", "inss"}),
    "aposentadoria especial": frozenset({"insalubre", "periculosa", "inss", "beneficio"}),
    "pensao morte": frozenset({"beneficio", "dependente", "obito", "inss"}),
    "auxilio doenca": frozenset({"incapacidade", "temporaria", "beneficio", "inss"}),
    "auxilio acidente": frozenset({"acidente", "sequela", "beneficio", "inss"}),
    "auxilio reclusao": frozenset({"recluso", "dependente", "inss", "beneficio"}),
    "bpc": frozenset({"loas", "assistencia", "idoso", "deficiencia", "beneficio"}),
    "loas": frozenset({"bpc", "assistencia", "beneficio", "prestacao"}),
    "salario maternidade": frozenset({"gestante", "maternidade", "beneficio", "inss"}),
    "carencia": frozenset({"contribuicao", "periodo", "inss", "requisito"}),
    "segurado": frozenset({"beneficiario", "inss", "contribuinte", "previdencia"}),
    "beneficiario": frozenset({"segurado", "dependente", "inss"}),
    "incapacidade": frozenset({"invalidez", "doenca", "auxilio", "pericia", "laudo"}),
    "invalidez": frozenset({"incapacidade", "permanente", "aposentadoria", "pericia"}),
    "revisao beneficio": frozenset({"calculo", "correcao", "inss", "reajuste"}),
    "tempo contribuicao": frozenset({"aposentadoria", "carencia", "previdencia", "inss"}),
    "seguridade social": frozenset({"previdencia", "assistencia", "saude", "inss"}),
    "contribuicao previdenciaria": frozenset({"inss", "recolhimento", "rgps", "encargo"}),
    # ── Direito bancário / fraude financeira ─────────────────────────────────
    "banco": frozenset({"instituicao", "financeira", "bancario", "caixa"}),
    "conta bancaria": frozenset({"deposito", "saque", "debito", "credito", "bancario"}),
    "fraude bancaria": frozenset({"estelionato", "golpe", "clonagem", "furto"}),
    "fraude": frozenset({"estelionato", "golpe", "enganacao", "falsidade"}),
    "debito": frozenset({"saque", "lancamento", "movimentacao", "desconto"}),
    "senha": frozenset({"autenticacao", "acesso", "credencial", "seguranca"}),
    "cartao": frozenset({"credito", "debito", "bancario", "clonagem", "cartao"}),
    "transferencia": frozenset({"pix", "ted", "remessa", "bancaria"}),
    "pix": frozenset({"transferencia", "instantanea", "bancaria"}),
    "saque": frozenset({"debito", "retirada", "movimentacao", "conta"}),
    "estelionato": frozenset({"fraude", "golpe", "enganacao", "falsidade"}),
    "clonagem": frozenset({"fraude", "cartao", "bancario", "furto"}),
    "responsabilidade banco": frozenset({"fortuito", "interno", "risco", "atividade"}),
    "fortuito interno": frozenset({"risco", "atividade", "banco", "responsabilidade"}),
